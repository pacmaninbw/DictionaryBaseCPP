...
bool PerformanceTestGenerator::generateAllPerformaneTests() noexcept
{
    ...
    std::cout << "// Warning, this file is generated by a test generator " << progName << "\n";
...
{
    std::cout << "typedef enum class " << enumName << testSize << "\n";
...
bool PerformanceTestGenerator::genTestDataStructVector(std::size_t testSize) const noexcept
{
    ...
    std::cout << "\nstatic std::vector<struct TestPairs<" << enumName + std::to_string(testSize) <<
        ">> " << tpVecName << " =\n{\n";
